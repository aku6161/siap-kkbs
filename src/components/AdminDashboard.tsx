  ...
  const handlePrintSingleReport = async (c: Complaint) => {
    ...
    printWin.document.write(`
      ...
      <body>
        ...
        <div class="grid-2col">
          <div class="grid-item"><div class="grid-lbl">No. Rujukan:</div><div class="grid-val" style="font-family: monospace; font-weight: bold; color: #2563eb;">${c.noRujukan}</div></div>
          <div class="grid-item"><div class="grid-lbl">Status Semasa:</div><div class="grid-val"><span class="badge status-${c.status}">${c.status}</span></div></div>
          <div class="grid-item"><div class="grid-lbl">Kategori Aduan:</div><div class="grid-val">${c.kategoriNama}</div></div>
          <div class="grid-item"><div class="grid-lbl">Lokasi Kejadian:</div><div class="grid-val">${c.lokasi}</div></div>
          <div class="grid-item"><div class="grid-lbl">Nama Pengadu:</div><div class="grid-val">${c.namaPengadu} (${c.telefon})</div></div>
          <div class="grid-item"><div class="grid-lbl">Emel Pengadu:</div><div class="grid-val">${c.emel}</div></div>
          <div class="grid-item"><div class="grid-lbl">Tarikh Aduan:</div><div class="grid-val">${c.tarikhMasa}</div></div>
          <div class="grid-item"><div class="grid-lbl">Tarikh Kejadian:</div><div class="grid-val">${c.tarikhKejadian || '-'}</div></div>
        </div>

        <div class="section-title">2. TAJUK & BUTIRAN ADUAN PENGADU</div>
        <div class="box-butiran">
          <div style="font-weight: bold; margin-bottom: 2px; color: #0f172a;">Tajuk: ${c.tajukAduan}</div>
          <div>${c.butiranAduan}</div>
        </div>
        ...
        ${c.rating ? `
          ...
          <div class="grid-2col">
            <div class="grid-item"><div class="grid-lbl">Tahap Kepuasan:</div><div class="grid-val"><strong>${c.rating} / 5 Bintang</strong></div></div>
            <div class="grid-item"><div class="grid-lbl">Tarikh Penilaian:</div><div class="grid-val">${c.ratingTarikh || '-'}</div></div>
            <div class="grid-item" style="width: 100%; border-right: none;"><div class="grid-lbl">Ulasan Pelanggan:</div><div class="grid-val">${c.ulasanPelanggan || 'Tiada ulasan tambahan.'}</div></div>
          </div>
        ` : ''}
