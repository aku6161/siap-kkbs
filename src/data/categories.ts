...
export const CATEGORIES: Record<ComplaintCategory, CategoryInfo> = {
  KEMUDAHAN: {
    ...
    telegramChatId: '-1003546212661',
    telegramLink: 'https://web.telegram.org/k/#-1003546212661',
    color: 'emerald',
  ...
  SISTEM: {
    ...
    telegramChatId: '-1003763181014',
    telegramLink: 'https://web.telegram.org/k/#-1003763181014',
    color: 'blue',
  ...
  PERKHIDMATAN: {
    ...
    telegramChatId: '-1004423616468',
    telegramLink: 'https://web.telegram.org/k/#-1004423616468',
    color: 'violet',
  ...
  KEBERSIHAN: {
    ...
    telegramChatId: '-1003921165191',
    telegramLink: 'https://web.telegram.org/k/#-1003921165191',
    color: 'amber',
